...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Section ======= -->
    <section class="section site-flexfreelance">
      <div class="container">
        <div class="row mb-5 align-items-center">
          <div class="col-md-12 col-lg-6 mb-4 mb-lg-0" data-aos="fade-up">
            <h2>freelance биржа</h2>
            <p class="mb-0">фриланс-услуги в один клик</p>
          </div>
        ...
        <div id="flexfreelance-grid" class="row no-gutter" data-aos="fade-up" data-aos-delay="100">
          <div class="item server col-sm-6 col-md-4 col-lg-4 mb-4">
          ...
          <div class="item net col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>developer</h3>
